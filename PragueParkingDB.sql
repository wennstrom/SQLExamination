...
/****** Object:  Database [PragueParking]    Script Date: 2020-03-04 22:02:34 ******/
CREATE DATABASE [PragueParking]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PragueParking', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PragueParking.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PragueParking_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PragueParking_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [PragueParking] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [PragueParking] SET  ENABLE_BROKER 
GO
